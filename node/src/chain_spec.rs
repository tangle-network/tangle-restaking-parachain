...
use tangle_polkadot_runtime as runtime;
...
pub fn polkadot_config() -> ChainSpec {
	...
	.with_name("Tangle Parachain")
	.with_id("tangle-parachain")
...
fn generate_genesis(
	...
	serde_json::json!({
		"balances": {
			"balances": endowed_accounts.iter().cloned().map(|k| (k, tangle_polkadot_runtime::UNIT * 10000)).collect::<Vec<_>>(),
		},
		"parachainInfo": {
			"parachainId": id,
		},
